...
export class PrixComponent implements OnInit {
  ...
  tarifs: Tarif[] = [];
  tarifselected: Tarif;
  constructor(private route: ActivatedRoute, private router: Router, private abonnementServices: AbonnementService) { }
  ...
  onPayer(prix: Tarif) {
    ...
    this.router.navigate(['/abonnement', 'form', prix.id]);
  }
}
