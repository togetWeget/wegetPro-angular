...
@Component({
  selector: 'app-video-ecole-add',
  templateUrl: './video-ecole-add.component.html',
  styleUrls: ['./video-ecole-add.component.scss']
})
export class VideoEcoleAddComponent implements OnInit {
photoForm: FormGroup;
  isNew: boolean;
  ...
  constructor(private fb: FormBuilder, private dialogRef: MatDialogRef<VideoEcoleAddComponent>,
  ...
  sendFiles(){
    this.fmService.submit(`${this.outils.getBaseUrl()}/videoGallerySousBlock`,
